    ...
    <div className="flex min-h-screen flex-col bg-bg">
      ...
      <div className="w-full max-w-md rounded-3xl border border-border bg-surface p-8 shadow-xl shadow-ink/[0.04]">
        <div className="flex flex-col items-center text-center">
          <div className="flex size-16 items-center justify-center overflow-hidden rounded-2xl shadow-lg shadow-brand-purple/25">
            <Image src="/logo-petope.png" alt="Petope" width={64} height={64} className="size-16 object-cover" priority />
          </div>
